...
class vueaccueil
{
    ...
    private function afficherAccueil() : string{
        ...
        <head>
          ...
          <title>Accueil</title>
      <link rel="stylesheet" href="/test/CustomBox/web/css/Accueil.css" media="screen">
      <link rel="stylesheet" href="/test/CustomBox/web/css/nicepage.css" media="screen">
          <script class="u-script" type="text/javascript" src="/test/CustomBox/web/js/jquery.js" defer=""></script>
          <script class="u-script" type="text/javascript" src="/test/CustomBox/web/js/nicepage.js" defer=""></script>
